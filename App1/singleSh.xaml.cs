...
namespace App1
{
    ...
    /// </summary>
    public sealed partial class singleSh : App1.Common.LayoutAwarePage
    {
        public singleSh()
        {
        ...
        {
            pageTitle.Text = "Разписание за " + getWeekNameOnBulgarian(navigationParameter.ToString());
            thisDay = navigationParameter.ToString();
        }
        ...
        string getWeekNameOnBulgarian(string day)
        {
            string toReturn = "";
            switch (day)
            {
